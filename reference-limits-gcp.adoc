...
. La creazione di volumi FlexVol fino alle dimensioni massime di 300 TiB è supportata utilizzando System Manager e la CLI ONTAP a partire da Cloud Volumes ONTAP 9.12.1 P2 e 9.13.0 P2.
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/concept-ha-google-cloud.html["Scopri come funziona lo storage in una coppia Cloud Volumes ONTAP ha eseguita in Google Cloud"^].
